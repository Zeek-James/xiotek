...
const Mission = () => {
  return (
    <div className="componentBlock" name="MissionSection">
      <h3>Our Mission</h3>
      <div className="missionBrief">
        As a team of experienced IT recruiters with quick access to over 500+
        super skilled software developers and other IT professionals worldwide,
        our objectives are:
      </div>
      <div className="missionBlocks">
        ...
        <div className="missionBlock">
          To create an atmosphere for learning, improvements, and resultant
          growth.
        </div>
        <div className="missionBlock">
